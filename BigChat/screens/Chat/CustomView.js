      ...
      return (
        ...
        <MapView
          provider = {PROVIDER_GOOGLE}
            ...
            zoomEnabled={false}>
          <MapView.Marker 
            coordinate = {{latitude: this.props.props.currentMessage.location.latitude,
              longitude: this.props.props.currentMessage.location.longitude}}/>
         </MapView>
        </TouchableOpacity>
      );
       ...
       <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
        ...
        return(
          <View style={{width:260,}} >
            <Text onPress={()=>this.ViewSnap(this.props.props.currentMessage.snap)} style={{fontSize:17,fontWeight:'bold',}}>   A new Snap! Click to delete it!</Text>
          </View>
        );
      }
        ...
        <View style={styles.audio}>
            ...
            {this.state.paused ? (
                <Ionicons onPress={this.play} name='ios-play' size={28} style={{color:'#2F4F4F', marginLeft:15}}/>
            ) : (
                <Ionicons onPress={this.pause} name='ios-pause' size={28} style={{color:'#2F4F4F', marginLeft:15}} />
            )}
            </View>
            <Video
